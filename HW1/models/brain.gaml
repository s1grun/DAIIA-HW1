...
global {
	...
	float globalDistance1 <- float(0);
	float globalDistance2 <- float(0);
	init {
...
//			write distance2;
//		}
		globalDistance1 <- distance +globalDistance1;
		globalDistance2 <- distance2 +globalDistance2;
		distance <-float(0);
		distance2 <-float(0);
		write "globalDistance1 "+globalDistance1;
		write "globalDistance2 "+globalDistance2;
	}
